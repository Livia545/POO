...
class Funcionario {
    ...
    getSalario() {
        return "Acesso negado! O salário é privado.";
    }
...
const funcionarios = [
    new Medico("Dr. João", "Cardiologista", 15000),
    new Medico("Dra. Ana", "Pediatra", 14000),
    new Enfermeiro("Carlos", "UTI", 5000),
    new Recepcionista("Mariana", "Noturno", 3000),
    new Cozinheiro("Pedro", "Cozinheiro", 4000),
    new Limpeza("Clara", "Limpeza", 2500),
    new Estagiario("Lucas", "Enfermagem")
];
